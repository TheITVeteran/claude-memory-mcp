...
@pytest.mark.asyncio
async def test_happy_repository_get_subgraph_parsing(mock_service: Any) -> None:
    ...
    mock_service.repo.client.select_graph.return_value.query.return_value = mock_result_set
